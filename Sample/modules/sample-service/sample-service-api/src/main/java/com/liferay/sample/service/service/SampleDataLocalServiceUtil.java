...
/**
 * Provides the local service utility for SampleData. This utility wraps
 * <code>com.liferay.sample.service.service.impl.SampleDataLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SampleDataLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.sample.service.service.impl.SampleDataLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SampleData addSampleData(SampleData sampleData) {
		return getService().addSampleData(sampleData);
	}
	 ...
	 */
	public static SampleData createSampleData(long sampleDataId) {
		return getService().createSampleData(sampleDataId);
	}
	 ...
	 */
	public static SampleData deleteSampleData(long sampleDataId)
		throws PortalException {

		return getService().deleteSampleData(sampleDataId);
	}
	 ...
	 * @return the sample data that was removed
	 */
	public static SampleData deleteSampleData(SampleData sampleData) {
		return getService().deleteSampleData(sampleData);
	}
	...
	public static SampleData fetchSampleData(long sampleDataId) {
		return getService().fetchSampleData(sampleDataId);
	}
	 ...
	 */
	public static SampleData fetchSampleDataByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchSampleDataByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 * @throws PortalException if a sample data with the primary key could not be found
	 */
	public static SampleData getSampleData(long sampleDataId)
		throws PortalException {

		return getService().getSampleData(sampleDataId);
	}
	 ...
	 */
	public static SampleData getSampleDataByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getSampleDataByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<SampleData> getSampleDatas(int start, int end) {
		return getService().getSampleDatas(start, end);
	}
	 ...
	 */
	public static List<SampleData> getSampleDatasByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getSampleDatasByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<SampleData> getSampleDatasByUuidAndCompanyId(
		...
		return getService().getSampleDatasByUuidAndCompanyId(
	 ...
	 */
	public static int getSampleDatasCount() {
		return getService().getSampleDatasCount();
	}
	 ...
	 */
	public static SampleData updateSampleData(SampleData sampleData) {
		return getService().updateSampleData(sampleData);
	}

	public static SampleDataLocalService getService() {
		return _service;
	}

	private static volatile SampleDataLocalService _service;
